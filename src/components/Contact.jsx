...
const Contact = () => {
  return (
    <>
    <Nav/>
    <h1 className='text-center font-bold text-3xl p-4'>Fill This Form to connect with us</h1>
  ...
  <div className="mx-auto w-full max-w-[550px]">
    <form action="https://formbold.com/s/FORM_ID" method="POST">
      ...
      <div className="mb-5">
        ...
        <input type="email" name="email" id="email" placeholder="" className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
      </div>
      <div className="mb-5">
